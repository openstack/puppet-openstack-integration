  ...
  case $::osfamily {
    ...
    'RedHat': {
      ...
      if defined('$::delorean_repo_path') and $::delorean_repo_path != '' {
        ...
        $delorean_repo = "https://trunk.rdoproject.org/centos${::os['release']['major']}-zed/puppet-passed-ci/delorean.repo"
      }

      if defined('$::delorean_deps_repo_path') and $::delorean_deps_repo_path != '' {
        $delorean_deps_repo = $::delorean_deps_repo_path
      } else {
        $delorean_deps_repo = "https://trunk.rdoproject.org/centos${::os['release']['major']}-zed/delorean-deps.repo"
      }
