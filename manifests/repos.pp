  ...
  case $facts['os']['family'] {
    ...
    'RedHat': {
      ...
      if $facts['delorean_repo_path'] and $facts['delorean_repo_path'] != '' {
        ...
        $delorean_repo = "https://trunk.rdoproject.org/centos${facts['os']['release']['major']}-antelope/puppet-passed-ci/delorean.repo"
      }

      if $facts['delorean_deps_repo_path'] and $facts['delorean_deps_repo_path'] != '' {
        $delorean_deps_repo = $facts['delorean_deps_repo_path']
      } else {
        $delorean_deps_repo = "https://trunk.rdoproject.org/centos${facts['os']['release']['major']}-antelope/delorean-deps.repo"
      }
