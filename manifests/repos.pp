  ...
  case $facts['os']['family'] {
    ...
    'RedHat': {
      ...
      $delorean_repo = pick(
        ...
        "https://trunk.rdoproject.org/centos${facts['os']['release']['major']}-dalmatian/puppet-passed-ci/delorean.repo"
      )
      $delorean_deps_repo = pick(
        $facts['delorean_deps_repo_path'],
        "https://trunk.rdoproject.org/centos${facts['os']['release']['major']}-dalmatian/delorean-deps.repo"
      )
