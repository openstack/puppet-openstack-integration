...
# Tempest 15.0.0 is the tagged release for Ocata.
# http://docs.openstack.org/releasenotes/tempest/v15.0.0.html
export TEMPEST_VERSION=${TEMPEST_VERSION:-15.0.0}
...
if [ "${TEMPEST_FROM_SOURCE}" = true ]; then
    ...
    run_tempest/bin/pip install -c https://git.openstack.org/cgit/openstack/requirements/plain/upper-constraints.txt?h=stable/ocata -U -r requirements.txt
